...
processed_data_path = os.path.join(base_path, 'water_data', 'output', 'processed_data_with_lags.csv')
df_cleaned.to_csv(processed_data_path)
...
plt.legend()
plt.title('LightGBM Predictions vs Observed Values')
plt.show()
...
model_save_path = os.path.join(base_path, 'models', 'lightgbm_model_v1.0.pkl')
